        ...
        Column(
            ...
            InfoCard(
                ...
                items = listOf(
                    ...
                    "Чистый БМ (без бонусов)" to "[НАСТ БМ] / [НБМ], [REAL PB] / [RPB]",
            ...
            InfoCard(
                ...
                items = listOf(
                    "Бонус к атаке заклинанием" to "[МАТКБ], [MATCB]",
                    "Бонус к СЛ спаброска" to "[МСПАСБ], [MSAVEB]",
                    "Модификатор заклинательной характеристики" to "[ММОД], [MMOD]"
                )
            )
            ...
            InfoCard(
                ...
                items = listOf(
                    ...
                    "Округление" to "ВНИЗ(a) / FLOOR(a) — до ближайшего меньшего целого\nВЕРХ(a) / CEIL(a) — до ближайшего большего целого",
