...
class SpellCardSerializer : JsonSerializer<SpellCard> {
    override fun serialize(src: SpellCard, typeOfSrc: Type, context: JsonSerializationContext): JsonElement {
        ...
        json.addProperty("upcastDamageFormula", src.upcastDamageFormula)
        ...
        json.add("additionalUpcastDamageFormulas", context.serialize(src.additionalUpcastDamageFormulas))
        json.add("additionalDamageTypesList", context.serialize(src.additionalDamageTypesList))
        json.addProperty("upcastOnlyOne", src.upcastOnlyOne)
        json.addProperty("upcastUserChoice", src.upcastUserChoice)
